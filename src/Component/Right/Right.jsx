...
const Right = () => {
    return (
        <div className="lg:rounded-lg rounded-xl">
            <div className="bg-slate-200 px-20 pt-5 pb-10 mt-20 rounded-xl">
                <h1 className="text-lg font-bold">Retirement Strategy</h1>
                <h2 className="font-semibold mt-4">Employee Contribution</h2>
                <div className="flex">
                    <input type="range" min={0} max="100" value="12" className="range range-xs mr-5" style={{
                        "range-color": 'red',
                    }} />
                    <div>12%</div>
                </div>
                ...
                <div>
                    <input type="range" min={0} max="100" value="12" className="range range-xs" style={{
                        "range-color": 'red',
                    }} />
                    <div>65%</div>
                    {/* <hr /> to-do */}
